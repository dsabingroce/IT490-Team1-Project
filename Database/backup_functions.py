...
def addScores_DBB(user, timeTrav, songLis, country, edm, hiphop, pop, rock):
...
def savePlaylist_DBB(user, playlist):
...
def sendMessage_DBB(fromUser, toUser, message):
